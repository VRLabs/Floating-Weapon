...
namespace VRLabs.FloatingAccessory
{
	public class FloatingAccessory : ScriptableObject
	{
		public const string packageName = "Floating-Accessory";
		...
		public static void FancyPackage()
		{
			...
			var editor = ScriptableObject.CreateInstance<FloatingAccessory>();
